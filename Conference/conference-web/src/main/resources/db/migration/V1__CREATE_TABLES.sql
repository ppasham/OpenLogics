...
(
    ticket_price_id       INT IDENTITY PRIMARY KEY,
...
(
    discount_code_id INT IDENTITY PRIMARY KEY,
...
(
    attendee_ticket_id INT IDENTITY PRIMARY KEY,
...
(
    time_slot_id         INT IDENTITY PRIMARY KEY,
...
(
    speaker_id    INT IDENTITY PRIMARY KEY,
    first_name    varchar(30)   NOT NULL,
    last_name     varchar(30)   NOT NULL,
